...
mkdir -p "${OUT_DIR}"/{forms,runbooks,scripts,env,checklists,monitoring,reports}
...
cp "${ROOT_DIR}/docs/runbooks/sos-standalone-contract.md" "${OUT_DIR}/runbooks/sos-standalone-contract.md"
cp "${ROOT_DIR}/docs/runbooks/sos-next-thread-handoff.md" "${OUT_DIR}/runbooks/sos-next-thread-handoff.md"
...
cp "${ROOT_DIR}/scripts/sos/daily-ops-report.sh" "${OUT_DIR}/scripts/daily-ops-report.sh"
...
if [[ -f "${ROOT_DIR}/docs/reports/sos-standalone-gate-report.md" ]]; then
  cp "${ROOT_DIR}/docs/reports/sos-standalone-gate-report.md" "${OUT_DIR}/reports/sos-standalone-gate-report.md"
fi
