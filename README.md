...
- Operator IA: Dashboard, Imports, Tenants, Campaign Engine, Alerts, Analytics, Reports, Settings.
...
- Revenue CSV import path with strict canonical schema + status tracking.
...
7. Verify bootstrap readiness:
   - API endpoint: `GET /v1/bootstrap/status`
